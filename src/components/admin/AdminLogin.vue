<template>
  <div class="login_container">
    <div class="login_box">
      <h1 style="margin-left: 26px; font-family: 'Microsoft YaHei',serif;" @click="adminLogin">管理员登录</h1>
      <!--登陆表单区域-->
  ...
  methods: {
    ...
    login () {
      this.$refs.loginFormRef.validate(async (valid) => {
        ...
        this.$router.push({ name: 'AdminHome', params: { username: this.loginForm.username } })
      })
    },
    adminLogin () {
