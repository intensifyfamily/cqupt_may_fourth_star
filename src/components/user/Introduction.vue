<template>
  <div style="margin-top: -2%;">
    <el-steps :active="0" align-center>
      <el-step title="推荐点赞" description="2020-03-23至2020-04-03"></el-step>
      <el-step title="学院复核" description="2020-04-03至2020-04-10"></el-step>
      <el-step title="专家评选" description="4月中旬前至5月上旬"></el-step>
      <el-step title="学校审定" description="5月上旬"></el-step>
      <el-step title="公开表彰" description="5月上旬"></el-step>
    </el-steps>
    <div class="btns">
      <el-button size="mini" @click="topush" type="primary">我要推荐(申报)</el-button>
      <el-button size="mini" @click="tolike" type="primary">查看已推荐</el-button>
    </div>
  </div>
</template>
...
export default {
  ...
  methods: {
    tolike () {
      ...
      } else { this.$router.push('/like') }
    },
    topush () {
      if (!window.sessionStorage.getItem('token')) {
        this.$message.warning('请先登录！')
        this.$router.push('/login')
      } else { this.$router.push('/push') }
    }
  }
}
</script>
...
/*is-wait title 颜色*/
.el-steps.el-steps--horizontal /deep/ .el-step.is-horizontal.is-center /deep/ .el-step__title.is-wait {
  color: #969696;
  font-weight: 700;
}
/*is-wait des 颜色*/
.el-steps.el-steps--horizontal /deep/ .el-step.is-horizontal.is-center /deep/ .el-step__description.is-wait {
  color: #969696;
  font-weight: 700;
}
/*is-finish des 颜色*/
.el-steps.el-steps--horizontal /deep/ .el-step.is-horizontal.is-center /deep/ .el-step__description.is-process {
  color: #a12327;
  font-weight: 700;
}
 /*is-process  title 颜色*/
